...
#/ Examples: ./run_loadtest.sh -u wolfgang.moser@woodmark.de -pw Pa$$w0rd -p 10 -j https://jitsi.dev.beyondcloud.com.br -d 180 -k ~/.ssh/id_rsa
#/ Options:
...
#/   -j, --jitsi-url: URL pointing to the Jitsi installation (optional, defaults to https://jitsi.dev.beyondcloud.com.br)
...
if [ -z "$jitsiUrl" ]; then
  jitsiUrl="https://jitsi.dev.beyondcloud.com.br"
fi
